...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.all_modules.itemSelectionChanged.connect(
            lambda: get_modules.list_functions(self))
        ...
        self.gridLayout_5.addWidget(self.turkish_doc, 1, 3, 1, 1)

        self.english_doc = QtWidgets.QTextBrowser(self.centralwidget)
        self.english_doc.setObjectName("english_doc")
        self.gridLayout_5.addWidget(self.english_doc, 1, 1, 1, 1)
        ...
        self.all_funcs.itemSelectionChanged.connect(
            lambda: get_modules.print_doc(self))
